...
const MODEL_OPTIONS = [
  ...
  { id: "gemini-2.5-flash-preview-05-20", label: "Gemini 2.5 Flash", provider: "gemini", badge: "✨", group: "Google (Free)" },
  { id: "gemini-2.5-pro-preview-05-06", label: "Gemini 2.5 Pro", provider: "gemini", badge: "💎", group: "Google (Free)" },
  { id: "gemini-3.5-flash", label: "Gemini 3.5 Flash", provider: "gemini", badge: "🌟", group: "Google (Free)" },
  ...
  { id: "openai/gpt-oss-120b", label: "GPT-OSS 120B", provider: "groq", badge: "🤖", group: "Groq (Free)" },
  ...
  { id: "meta-llama/llama-4-maverick:free", label: "Llama 4 Maverick", provider: "openrouter", badge: "🦙", group: "OpenRouter (Free)" },
  ...
  if(view==="home") return (
    <div style={{minHeight:"100vh",background:"#06061a",fontFamily:"monospace",color:"#e0e0ff",display:"flex",flexDirection:"column",overflow:"hidden",position:"relative"}}>
      ...
      <div style={{flex:1,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:"60px 20px 40px",textAlign:"center",position:"relative",zIndex:1}}>
        ...
        {/* UPGRADE PLANS - only for non-admin logged-in users */}
        {!isAdmin&&(
          <div style={{width:"100%",maxWidth:800,marginBottom:60}}>
            ...
            <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(200px,1fr))",gap:14}}>
              ...
              <div style={{background:"linear-gradient(135deg,#1a0800,#0d0d24)",border:"2px solid #f59e0b",borderRadius:14,padding:22,position:"relative"}}>
                <div style={{position:"absolute",top:-9,right:12,background:"linear-gradient(90deg,#f59e0b,#ef4444)",color:"#fff",fontSize:8,fontWeight:900,padding:"3px 10px",borderRadius:8,letterSpacing:1,whiteSpace:"nowrap"}}>✦ BEST</div>
                ...
                <div style={{fontSize:10,color:"#3a3a6a",marginBottom:14}}>cancel anytime</div>
                {[["∞","Unlimited tokens"],["🤖","Claude Opus AI chat"],["✓","Unlimited projects"],["⚡","Everything in Pro"]].map(([i,f])=>(
          ...
          {adminTab==="settings"&&(
            <div style={{flex:1,overflowY:"auto",padding:"22px 26px"}}>
              ...
              <div style={{background:C.panel,border:`1px solid ${C.border}`,padding:20,borderRadius:8,marginBottom:16}}>
                {[["Model",MODEL],["Admin User",ADMIN_USER],["API Route","/api/chat"],["Version",FORGE_VERSION]].map(([k,v])=>(
